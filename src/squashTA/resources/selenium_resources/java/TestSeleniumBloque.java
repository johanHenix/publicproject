...
public class TestSeleniumBloque {

    @Test
    public void TestSeleniumJUnit_erreur () throws Exception{
        ...
        driver.findElement(By.xpath("//input[@class='aagLFyf gsfi']")).sendKeys("squastest.com");
 
        driver.findElement(By.xpath("//input[@class='aagLFyf gsfi']")).sendKeys(Keys.ENTER);
